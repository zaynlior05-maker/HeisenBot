...
btn_base3 = types.InlineKeyboardButton('🔸' + month_3 + '-MxG-V' + day_3 + '-1', callback_data='base3')
btn_base4 = types.InlineKeyboardButton('🔸' + month_3 + '-MxG-V' + day_3 + '-2', callback_data='base4')
btn_base5 = types.InlineKeyboardButton('🔸' + month_2 + '-MxG-V' + day_2, callback_data='base5')
btn_base6 = types.InlineKeyboardButton('🔸' + month_1 + '-MxG-V' + day_1 + '-1', callback_data='base6')
btn_base7 = types.InlineKeyboardButton('🔸' + month_1 + '-MxG-V' + day_1 + '-2', callback_data='base7')
